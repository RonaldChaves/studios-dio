CREATE TABLE pessoas_ (
   id INT NOT NULL PRIMARY KEY AUTOINCREMET
   nome VARCHAR(30) NOT NULL,
   nascimento DATE,
);

INSERT INTO pessoas (nome, nascimento) VALUES ('Ronald', '2003-01-07');
INSERT INTO pessoas (nome, nascimento) VALUES ('Casé', '1993-07-12');
INSERT INTO pessoas (nome, nascimento) VALUES ('Laura', '1999-01-09');

-- criar inserções necessárias que foram aprendidas no módulo de MySql
